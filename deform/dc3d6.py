...
def dc3d6(alpha, x, y, depth, dip, al1, al2, aw1, aw2, disl1, disl2, disl3):
    """
    Compute displacements (ux, uy, uz) for a buried fault in a semi-infinite medium with depth, including tensile components.
